...
function initAdmin() {
  ...
  var orders = [];
  var markup; // Table html markup store

  // Using axios for AJAX call
  axios__WEBPACK_IMPORTED_MODULE_1__["default"].get('/admin/orders', {
    ...
    orders = res.data;
    // generate html markup for orders using data received
